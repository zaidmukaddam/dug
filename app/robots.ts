...
//
// The discovery documents stay crawlable on purpose: they describe the whole
// surface without querying it, and a crawler that indexes them costs nothing
// upstream. /mcp is allowed for the same reason — it is a fixed endpoint, not a
// lookup — even though it answers a GET with 405.
