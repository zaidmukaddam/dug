...
var table = map[string]Status{
	...
	"server delete prohibited":   {"server delete prohibited", "the registry blocks deletion, often a dispute or a high value name", true},
	...
	"pending delete":             {"pending delete", "scheduled for removal, typically five days before the name drops", true},
	...
	"redemption period":          {"redemption period", "deleted but recoverable, usually thirty days, restoring costs a fee", true},
